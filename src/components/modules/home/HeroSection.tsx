    ...
    <section className="bg-[#FAFAFF] flex flex-col justify-center items-center z-50 overflow-hidden">
      <Container>
        <div className="lg:mt-[60px] mt-10 md:mt-12 pb-3 flex flex-col items-center justify-center">
          ...
          <div className="hidden  lg:block relative max-h-[800px] lg:h-[800px] md:h-[500px] max-w-[1200px] w-full z-[100] mx-auto overflow-hidden">
            <div className="relative h-full w-full flex justify-center items-center">
              <Image
                src={heroCardImg}
                alt="logo"
                className="mt-5 max-h-[80vh] z-30 absolute"
              />
              ...
              <div className="absolute inset-0 flex justify-center items-center bg-[#FAFAFF] max-w-[1600px] w-[1400px] mx-auto left-1/2 -translate-x-1/2 overflow-hidden">
                <video
                  autoPlay
                  loop
                  muted
            ...
            <div className="absolute -bottom-[50px] left-1/2 max-w-[880px] w-full gap-5 -translate-x-1/2 py-[30px] grid grid-cols-1 lg:grid-cols-3 text-center items-center justify-items-center">
              {[
                {
                  title: "Easy Set Up",
                  description:
