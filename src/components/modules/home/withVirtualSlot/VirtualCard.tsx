  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute top-[14vh] lg:top-[18vh] xl:top-[5vh] z-[200] flex rounded-[24px] bg-white p-[10px] w-full justify-between h-full">
          {/* left side */}
        ...
        <div className="absolute top-[14vh] lg:top-[18vh] xl:top-[5vh] z-[20] rounded-[2px] bg-black opacity-[0.07] blur-[7px] xl:h-[200px] xl:w-[550px] 2xl:h-[400px] 2xl:w-[650px] 2.5xl:w-[720px]"></div>
