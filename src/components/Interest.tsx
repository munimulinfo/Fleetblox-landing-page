...
const SubmitDetails = () => {
    ...
    return (
        ...
        <div className="relative flex max-h-[900px] md:h-[800px] overflow-scroll items-center justify-between  w-full max-w-[650px] flex-col rounded-lg bg-bg_white px-[20px] xs:px-[30px] sm:px-[60px] py-[20px] md:py-[60px]    md:shadow-lg">
            ...
            <form onSubmit={handleSubmit} id='submitForm' className="w-full flex flex-col gap-[40px] scroll-mt-[20px] mt-[40px] overflow-y-scroll overflow-hidden max-h-[1200px]" >
                <div>
