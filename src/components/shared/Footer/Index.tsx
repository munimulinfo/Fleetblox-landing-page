    ...
    <div>
      ...
      <div className="h-auto w-full   bg-bg_dark_blue">
        <div className="mx-auto  max-w-[1920px]">
          <div className="  pb-[50px]   sm:pb-[75px]   md:pb-[100px] custom_padding xl:px-[110px] xl:pb-[70px] 2xl:px-[170px] 2xl:pb-[125px] 3xl:px-[280px]">
            {/* animation */}
            <div className="relative flex flex-col items-center justify-center py-[120px]">
              <h1 className="footer_title z-[300] font-montserrat text-[36px] xl:text-[33px] 2xl:text-[40px] 2.5xl:text-[52px]">
                Revolutionize Your Fleet With Modern, Hardware- Free solution at your fingertips!
              </h1>
              <CustomeButton href="/collections/select-country" text="Get early Access" className=" capitalize z-[110] mt-[32px]" />
