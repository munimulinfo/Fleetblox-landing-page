...
const page = () => {
  const items = [
    {
      id: 1,
      title: "AI-Powered Image Recognitions",
      description:
        "Capture vehicle images at the start and end of trips, allowing the AI to assess the vehicle’s exterior and internal components for wear, damage, or maintenance needs.",
    },
    {
      id: 2,
      title: "Trip-Based Inspections Control",
      description:
        "Inspections are automatically triggered when a vehicle departs and upon return, ensuring that each vehicle’s condition is evaluated before and after every trip",
    },
    {
      id: 3,
      title: "Real-Time Feedback",
      description:
        "Receive immediate insights and reports on the vehicle's condition after each trip, highlighting potential issues like tire damage, engine performance, or body wear.",
    },
    {
      id: 4,
      title: "Automated Detection of Anomalies",
      description:
        "The AI analyzes inspection data to detect anomalies or maintenance needs, flagging potential problems that may have occurred during the trip.",
    },
    {
      id: 5,
      title: "Remote Accessibility",
      description:
        "Perform inspections remotely—whether from the office or the field—eliminating the need for physical checkups and ensuring continuous fleet performance.",
    },
  ];
  return (
    <div>
        ...
        <div className="lg:max-w-[calc(100vw-30px)] xxl:max-w-[1440px] mx-auto w-full flex flex-col px-5 lg:flex-row items-center justify-between">
          <div className="lg:pl-[130px] w-[60%]">
            ...
            <p className="text-[#333] text-[16px] leading-6 mt-[10px] lg:mt-4 mb-5 font-openSans">
              ...
              and return from their routes, the AI automatically conducts remote
              inspections, ensuring your fleet is in optimal condition using
              advanced image recognition and machine learning.
            </p>
            <Link
          ...
          <div className=" w-[50%]  py-10 lg:pl-[60px]">
            <Image
              src="/images/remoteInspectionHero.png"
      ...
      <section className="max-w-[1200px] mx-auto w-full mt-[60px] lg:mt-[100px] px-5">
        <div className="max-w-[840px] mx-auto w-full text-center">
          <h2 className="text-[#04082C] text-[28px] lg:text-[36px] font-bold text-center leading-[1.1] mb-[10px]">
            Intelligent Remote Inspection with AI Accuracy & Operational Ease
          </h2>
          <p className="text-[#333] text-[16px] leading-6 font-openSans">
            Leverages AI to automatically conduct remote inspections, ensuring
            your fleet remains in optimal condition
          </p>
        </div>
        <div className="flex flex-col lg:items-center lg:flex-row py-8 lg:py-[60px] justify-between">
          <div className="">
            <Image
              src="/images/remoteInspectionBody.png"
