...
const page = () => {
    ...
    const whyFleetManager = [
        ...
        },
        {
            ...
            description:
                "Share real-time inspection data with teams and partners.",
        },
        {
            icon: BuildTrust,
            title: "Build Trust",
