...
export default function Access({ permission }: { permission: string[] }) {
    ...
    const permissions = [
        ...
        { key: 'EV_battery_capacity', icon: EV_Capacity, label: 'EV battery capacity' },
        { key: 'EV_charging_status', icon: Charging_Status, label: 'EV charging status' },
        { key: 'EV_charge_limit', icon: EV_limit, label: 'EV charge limit' },
        { key: 'EV_set_charge_limit', icon: EV_SET_Limit, label: 'EV set charge limit' },
        { key: 'EV_start_stop_charge', icon: EV_ST, label: 'EV start & stop charge' },
    ];
